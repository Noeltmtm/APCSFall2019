...
public class ArrayListPracticeLab 
{
	 ...
	 */
	public static void swapPairs(ArrayList<String> arrList) {
		for(int i =0; i < (arrList.size())/2; i++) {
			String store = arrList.get(2*i + 1);
			arrList.set(2*i + 1, arrList.get(2*i));
			arrList.set(2*i, store);
		}
	}
	...
	public static void main(String[] args) 
	{
		...
		printMe(convertArrayToList(test_max_1));
